...
## Execution Steps
1. **Load Steering Context**: Read entire `.sdd/steering/` directory including:
   - Default files: `structure.md`, `tech.md`, `product.md`
   - All custom steering files (regardless of mode settings)
   - This provides complete project memory, integrations, and context before initialization
...
- Only initialization and post-init integrations are performed in this phase
</instructions>

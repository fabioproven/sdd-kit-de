...
9. **semantic-layer.md** - Metric contracts (formula, grain, population, owner), canonical entities, shared dimensions, and the terms the business uses ambiguously *(data projects — offer it whenever `integrations.md` has a real data platform)*

**Integrations** (written verbatim after displaying embedded setup guide):
10. **jira.md** - Jira Cloud sync: auto-creates Epics, Stories, and Subtasks at each SDD phase
11. **azure-devops.md** - Azure DevOps Boards sync: auto-creates Epics, User Stories, and Tasks at each SDD phase
